 ...
 document.addEventListener("DOMContentLoaded", (event) => {
    ...
    load_tl.to(logo, {duration: 0.75, top: 0, opacity: 1, ease: "power2.out", delay: 0.5}, "+=0.25")
        ...
        .to(projectSelectors, {duration: 0.15, stagger: 0.125, opacity: 1, ease: "power2.out"}, "-=0.5")
        .to(projectDivider, {duration: 0.65, width: '100%', opacity: 1, ease: "power2.out"}, "-=0.1")
    ...
    gsap.to(socialsText, {duration: 0.45, top: 0, stagger: 0.15, opacity: 1, ease: "power2.out", delay: 3})
    gsap.to(leftHandText, {duration: 0.45, top: 0, stagger: 0.15, opacity: 1, ease: "power2.out", delay: 3})
    gsap.to(bioLines, {duration: 0.45, top: 0, stagger: 0.15, opacity: 1, ease: "power2.out", delay: 3})
    gsap.to(bioText, {duration: 0.01, top: 0, opacity: 1, ease: "power2.out", delay: 3})
    gsap.to(banner, {duration: 0.5, top: 'calc(100% - 56px)', opacity: 1, ease: "power2.out", delay: 3.85}) 
 });
